...
public class CarAudio2 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (m_StartedSound)
        {
            ...
            float pitch = ULerp(lowPitchMin, lowPitchMax, angularVelocity);
            ...
            else
            {
                ...
                float accFade = Mathf.Abs(angularVelocity);
                float decFade = 1 - accFade;

                // get the high fade value based on the cars revs
                float highFade = Mathf.InverseLerp(0.2f, 0.8f, angularVelocity);
